...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', 'polling_db'),
        'USER': os.environ.get('DATABASE_USERNAME', 'polling_user'),
        'PASSWORD': os.environ.get('DATABASE_PASSWORD', 'polling_password'),
